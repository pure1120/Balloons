# Balloons
## Short Description
*Balloons is a small interactive game that uses a webcam and machine vision to recognise hand gestures in real time. Players interact with floating balloons on the screen using simple hand movements.
Instead of using a mouse or keyboard, the player’s body becomes the controller. The system detects hand gestures and translates them into playful actions such as attracting balloons, popping them, or briefly freezing the scene.*
## Concept / Intent
...
Open Palm
Attract nearby balloons toward the hand.
Closed Fist
Pop nearby balloons.
Thumb Up
Freeze the scene for a short moment.
The goal is simply to pop as many balloons as possible within a limited time.*
## Requirements
